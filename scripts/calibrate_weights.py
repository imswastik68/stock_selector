...
# + BEARISH_EVENT_WEIGHTS, OHLCV-derivable only). Refreshed 2026-07 (Phase 2, strict
# validated-only pass): rs_quality_strong zeroed (failed backtest, -1.47pp/n=16,907,
# also removed from REGIME_WEIGHTS); near_52w_high added (best validated signal,
# +5.09pp/n=15,005, now scored live -- see src/scorer.py:_build_signal_map).
CURRENT_WEIGHTS: dict[str, int] = {
    ...
    "near_52w_high":        3,  # best validated signal, now scored live (Phase 2)
